...
//          }
       queryResponse=queryResponse+"<table style=\"width: 100%\" border=\"1\"><tbody>";   
      	while (itr.hasNext()){
            ...
            queryResponse = queryResponse +"<tr><td>"+Integer.toString(sd._did)+"<br></td><td>"+sd._title+"<br></td><td>"+Double.toString(sd._score)+"<br></td></tr>";
          }
